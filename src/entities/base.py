...
class Genome:
    ...
    """
    def __init__(self, species, speed, vision, hunger_rate, max_age, reproductive_crit, size, fertility, energy=100, age=0):
    ...
    def get_metabolism(self):
        ...
        return metabolism_constant * (self.size ** 0.75) * self.hunger / (self.speed * self.vision)
    ...
    def distance(self, other: 'Genome'):
        ...
        dist = (
            ...
            1.0 * abs((self.hunger - other.hunger) / self.hunger) +
...
if __name__ == '__main__':
    g1 = Genome('shark', speed=5, vision=10, hunger_rate=3, max_age=20, reproductive_crit=0.3, size=50, fertility=2)
    g2 = Genome('shark', speed=6, vision=9, hunger_rate=4, max_age=18, reproductive_crit=0.3, size=55, fertility=3)
